...
const Bookmarks = ({bookmarks,markAsRead}) => {
    ...
    return (
        <div>
            ...
            <div className="bg-purple-50 border-2 border-purple-400 p-4 rounded-lg mb-4 text-center"><h2 className="text-purple-600 font-bold text-xl">Spent time on read : <span>{markAsRead}min</span></h2></div>
